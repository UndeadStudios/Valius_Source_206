...
public class CrystalChest {
	...
	public static final Item[] RARE_CHEST_REWARDS = { new Item(12641), new Item(12026), new Item(12056), new Item(12086), new Item(20161), new Item(20143), new Item(11836), new Item(11804), new Item(11802), new Item(11826), new Item(11828), new Item(11830), new Item(ItemNames.UNCUT_DRAGONSTONE), new Item(ItemNames.UNCUT_ONYX), new Item(ItemNames.DRAGON_SPEAR), new Item(ItemNames.DRAGON_2H_SWORD), new Item(11935, Utility.random(100)), new Item(537, Utility.random(100)), new Item(11944, Utility.random(75)), new Item(4151),
	 new Item(10330), new Item(12437), new Item(12526), new Item(5000), new Item(5001), new Item(5002), new Item(5003), new Item(5008), new Item(5009), new Item(5010), new Item(5011), new Item(4067, Utility.random(6)), new Item(12829), new Item(4708), new Item(4710), new Item(4712), new Item(4714), new Item(4716), new Item(4718), new Item(4720), new Item(4722), new Item(4724), new Item(4726), new Item(4728), new Item(4730), new Item(4732), new Item(4734), new Item(4736), new Item(4738), };
