...
public class GlobalMessages {
	...
	public static final String[] ANNOUNCEMENTS = { 
			...
			"You are able to donate with OSRS and RS3 gold! Message Mod Divine.",
		...
		"Do you love Valius? Please show us some love by purchasing some Valius Bucks!",
		...
		"Here on Valius, we have GAMBLING. Check out the online donation shop to buy a dice bag!",
		"We also have an in-game Valius Bucks shop for players to use their in-game bucks.",
