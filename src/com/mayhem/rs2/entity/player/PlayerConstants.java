...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "Trebble", "Mod divine", "mod andy", "mod dottel" };
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("Trebble") || p.getUsername().equalsIgnoreCase("Mod divine") || p.getUsername().equalsIgnoreCase("Mod dottel");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("Trebble") || p.getUsername().equalsIgnoreCase("Mod divine") || p.getUsername().equalsIgnoreCase("Mod andy");
	}
